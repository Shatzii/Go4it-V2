        ...
        <div className="md:hidden fixed bottom-16 inset-x-0 bg-gray-800 border-t border-gray-700 p-4 z-10 shadow-lg animate-in slide-in-from-bottom duration-200 max-h-[70vh] overflow-y-auto">
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-5 gap-4 mb-6">
              ...
              <Link href="/strategy-board">
                <div className="flex flex-col items-center" onClick={() => setShowMoreMenu(false)}>
                  <div className={`rounded-full p-3 ${location === "/strategy-board" || location.startsWith("/strategy-board/") ? "bg-cyan-500 text-white" : "bg-gray-700 text-gray-200"}`}>
                    <Clipboard className="h-5 w-5" />
                  </div>
                  <span className="text-xs mt-2 text-center text-white font-medium">Strategy Board</span>
                </div>
              </Link>
