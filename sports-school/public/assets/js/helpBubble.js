...
const characters = {
  stella: {
    ...
    welcomeMessage:
      "Hi there! I'm Stella, your learning guide. Need any help navigating the platform?",
    idleMessages: [
  ...
  max: {
    ...
    welcomeMessage:
      'Hey! Max here, ready to help you on your learning adventure! What can I help with?',
    idleMessages: [
  ...
  nova: {
    ...
    welcomeMessage:
      "Hello, I'm Nova. I'm here to help you navigate through your learning journey. Take your time.",
    idleMessages: [
...
const contextualHelp = {
  ...
  'law-school': {
    title: 'Law School',
    description:
      'Welcome to the Shatzii School of Law. Here you can study legal subjects and prepare for the UAE Bar Exam.',
    tips: [
  ...
  'law-school-admin': {
    ...
    description:
      'This is the administrator dashboard for the Shatzii School of Law where you can manage all school operations.',
    tips: [
  ...
  'law-school-compliance': {
    ...
    description:
      'This dashboard helps ensure the law school meets all legal and accreditation requirements.',
    tips: [
  ...
  'superhero-school': {
    ...
    description:
      'Welcome to the Neurodivergent Superhero School. This is where your unique abilities become superpowers!',
    tips: [
  ...
  'superhero-school-staff': {
    ...
    description:
      'Manage the staff and create specialized instructors for the Neurodivergent Superhero School.',
    tips: [
  ...
  'language-school': {
    ...
    description:
      'Welcome to the Language Learning School. Here you can learn multiple languages through immersive experiences.',
    tips: [
...
function createHelpBubble() {
  ...
  Object.keys(characters).forEach((charKey) => {
    ...
    if (
      charKey === Object.keys(characters).find((k) => characters[k].name === currentCharacter.name)
    ) {
