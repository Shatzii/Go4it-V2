  ...
  const courseBuilder = (function() {
    ...
    function loadCourse(savedData) {
      ...
      if (savedData.accessibility) {
        document.getElementById('dyslexia-support').checked = savedData.accessibility.dyslexiaSupport;
        ...
        document.getElementById('multiple-formats').checked = savedData.accessibility.multipleFormats;
        document.getElementById('simplified-language').checked = savedData.accessibility.simplifiedLanguage;
        document.getElementById('progress-tracking').checked = savedData.accessibility.progressTracking;
      }
