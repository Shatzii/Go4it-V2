...
export interface AIProfessor {
   ...
   */
  startConversation(userId: number, topic: string, initialMessage?: string): Promise<Conversation>;
   ...
   */
  adaptToLearningProfile(learningProfile: LearningProfile): Promise<Record<string, any>>;
}
...
export class AIProfessorFactory {
   ...
   */
  static createProfessor(domain: string, profile: ProfessorProfile): AIProfessor | null {
