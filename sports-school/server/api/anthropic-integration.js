...
function createTeacherSystemPrompt(teacherConfig) {
  ...
  if (supportTypes && supportTypes.length > 0) {
    ...
    supportDesc =
      'You are skilled at supporting neurodivergent students with various learning needs.';
  }
  ...
  if (formalityLevel) {
    if (formalityLevel >= 4) {
      ...
      formalityDesc =
        'You communicate in a casual, friendly manner while maintaining professionalism.';
    } else {
