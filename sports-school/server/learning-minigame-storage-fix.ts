...
export function applyMissingLearningMiniGameMethods() {
  ...
  prototype.getMiniGamesByGradeLevel = async function (
    gradeLevel: string,
  ): Promise<LearningMiniGame[]> {
    return learningMiniGameStorage!.getMiniGamesByGradeLevel(gradeLevel);
  };

  prototype.getMiniGamesByDifficulty = async function (
    difficulty: number,
  ): Promise<LearningMiniGame[]> {
    return learningMiniGameStorage!.getMiniGamesByDifficulty(difficulty);
  };

  prototype.createMiniGame = async function (
    game: InsertLearningMiniGame,
  ): Promise<LearningMiniGame> {
    return learningMiniGameStorage!.createMiniGame(game);
  };

  prototype.updateMiniGame = async function (
    id: number,
  ...
  prototype.createMiniGameContent = async function (
    content: InsertMiniGameContent,
  ): Promise<MiniGameContent> {
    return learningMiniGameStorage!.createMiniGameContent(content);
  };

  prototype.updateMiniGameContent = async function (
    id: number,
  ...
  prototype.getUserMiniGameProgress = async function (
    userId: number,
  ): Promise<UserMiniGameProgress[]> {
    return learningMiniGameStorage!.getUserMiniGameProgress(userId);
  };

  prototype.getUserMiniGameProgressByGame = async function (
    userId: number,
    gameId: number,
  ...
  prototype.createUserMiniGameProgress = async function (
    progress: InsertUserMiniGameProgress,
  ): Promise<UserMiniGameProgress> {
    return learningMiniGameStorage!.createUserMiniGameProgress(progress);
  };

  prototype.updateUserMiniGameProgress = async function (
    id: number,
  ...
  prototype.completeMiniGame = async function (
    userId: number,
    gameId: number,
    score: number,
    timeSpent: number,
  ...
  // Activity tracking
  prototype.recordUserMiniGameActivity = async function (
  ...
  prototype.getUserMiniGameActivities = async function (
    userId: number,
    gameId: number,
  ): Promise<UserMiniGameActivity[]> {
  ...
  prototype.getTopPerformingMiniGames = async function (
    limit?: number,
  ...
  prototype.getMiniGameRecommendations = async function (
    userId: number,
  ): Promise<MiniGameRecommendation[]> {
