...
async function initializeElementarySchool(storage: IStorage): Promise<void> {
  ...
  try {
    ...
    const schoolData: InsertSchool = {
      ...
      description:
        'A specialized elementary school for neurodivergent learners from preschool through 6th grade, featuring a superhero-themed curriculum and personalized learning approaches.',
      type: 'elementary',
    ...
    const homePageData: InsertPage = {
      ...
      metaDescription:
        'Starworld Elementary provides specialized education for neurodivergent learners from preschool through 6th grade.',
      metaKeywords:
        'neurodivergent, elementary school, ADHD, autism, dyslexia, personalized learning',
      layout: 'superhero',
      order: 1,
    };
    ...
    const aiTeacherData: InsertAiTeacher = {
      ...
      subject: 'Science',
      description:
        'A friendly and energetic science teacher who specializes in making complex concepts visual and interactive. Professor Starbright uses cosmic themes and space adventures to teach science.',
      avatarUrl: '/assets/images/prof-starbright.svg',
      teachingStyle:
        'Visual, hands-on learning with lots of movement breaks and interactive demonstrations. Uses cosmic themes and superhero analogies to explain scientific concepts.',
      specialties: 'ADHD, Sensory Processing, Visual Learning',
      neurotypeTailoring:
        'Provides frequent movement breaks, uses visual aids and demonstrations, offers sensory-friendly explanations with tangible examples.',
      ...
      personalityPrompt:
        'Enthusiastic, positive, patient, and encouraging. You get excited about scientific discoveries and help students see themselves as young scientists with special powers of observation and curiosity. You are playful and incorporate cosmic themes and space adventures in your teaching.',
      active: true,
    };
    ...
    const resourceData: InsertResource = {
      ...
      description:
        'Customizable visual schedule templates designed for elementary students with ADHD, autism, and executive functioning challenges.',
      type: 'download',
...
async function initializeMiddleHighSchools(storage: IStorage): Promise<void> {
  ...
  try {
    ...
    const middleSchoolData: InsertSchool = {
      ...
      description:
        'A supportive middle school environment for neurodivergent students in grades 7-8, emphasizing academic growth while developing executive functioning and social skills.',
      type: 'middle',
      gradeRange: '7-8',
    ...
    const highSchoolData: InsertSchool = {
      ...
      description:
        'A comprehensive high school designed for neurodivergent students in grades 9-12, providing rigorous academics with appropriate accommodations and transition planning.',
      type: 'high',
      gradeRange: '9-12',
...
async function initializeLawSchool(storage: IStorage): Promise<void> {
  ...
  try {
    ...
    const schoolData: InsertSchool = {
      ...
      slug: 'shatzii-law',
      description:
        'A specialized law school designed for neurodivergent students, offering comprehensive legal education with UAE Bar Exam preparation and accommodations for diverse learning styles.',
      type: 'law',
    ...
    const homePageData: InsertPage = {
      ...
      metaDescription:
        'Shatzii School of Law provides specialized legal education for neurodivergent students with UAE Bar Exam preparation.',
    ...
    const aiTeacherData: InsertAiTeacher = {
      ...
      description:
        'A thorough and methodical Constitutional Law professor who specializes in making complex legal frameworks accessible through clear structures and visual frameworks.',
      avatarUrl: '/assets/images/prof-justice.svg',
      teachingStyle:
        'Structured, systematic approach with visual frameworks, case breakdowns, and comprehensive outlines. Uses analogies and real-world examples to connect abstract concepts.',
      specialties: 'ADHD, Dyslexia, Visual Learning',
      neurotypeTailoring:
        'Provides structured outlines, visual frameworks, and clear organization. Breaks complex topics into manageable components with frequent comprehension checks.',
      ...
      personalityPrompt:
        'Methodical, precise, and patient. You have a strong commitment to justice and helping students understand the foundational principles of constitutional law. While thorough and detailed, you ensure information is presented in a structured, accessible way that supports different learning styles.',
      active: true,
    };
...
async function initializeLanguageSchool(storage: IStorage): Promise<void> {
  ...
  try {
    ...
    const schoolData: InsertSchool = {
      ...
      description:
        'A specialized language school that adapts to neurodivergent learning styles, offering multi-language acquisition programs with an emphasis on practical communication skills.',
      type: 'language',
      gradeRange: 'All Ages',
    ...
    const homePageData: InsertPage = {
      ...
      metaDescription:
        'Polyglot Language Institute provides specialized language learning for neurodivergent students across multiple languages.',
    ...
    const aiTeacherData: InsertAiTeacher = {
      ...
      subject: 'Spanish',
      description:
        'A vibrant and engaging Spanish teacher who specializes in multisensory language learning techniques. Profesora Flores makes language acquisition fun and accessible through immersive techniques.',
      avatarUrl: '/assets/images/prof-flores.svg',
      teachingStyle:
        'Multisensory approach combining visual aids, movement, music, and storytelling. Emphasizes practical conversation skills through immersive scenarios and real-world contexts.',
      specialties: 'ADHD, Dyslexia, Auditory Processing',
      neurotypeTailoring:
        'Uses visual vocabulary supports, incorporates movement and rhythm for memory retention, provides multiple pathways to learn grammar concepts, and offers flexible practice options.',
      ...
      personalityPrompt:
        'Warm, energetic, and enthusiastic about Spanish language and culture. You are encouraging and create a positive, supportive learning environment. You use humor appropriately and celebrate students progress. Your passion for language learning is contagious.',
      active: true,
    };
