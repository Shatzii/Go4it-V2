  ...
  useEffect(() => {
    ...
    if (focusTimer.isActive && focusTimer.timeLeft > 0) {
      ...
      setFocusTimer(prev => ({
        ...
        timeLeft: prev.isBreak ? settings.adhd.timerDuration * 60 : settings.adhd.breakDuration * 60
      }));
                  ...
                  {settings.adhd.focusTimer && (
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-center gap-2">
                        ...
                        >
                          {focusTimer.isActive ? <Pause className="w-4 h-4" /> : <Play className="w-4 h-4" />}
                        </Button>
                      ...
                      <div className="space-y-2">
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => updateSetting('adhd', 'timerDuration', value[0])}
                          max={60}
                          min={5}
                          step={5}
                          className="w-full"
                        />
                        <span className="text-sm text-gray-600">{settings.adhd.timerDuration} minutes</span>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => updateSetting('adhd', 'breakDuration', value[0])}
                          max={30}
                          min={1}
                          step={1}
                          className="w-full"
                        />
                        <span className="text-sm text-gray-600">{settings.adhd.breakDuration} minutes</span>
                      </div>
                    </div>
                  )}
                </CardContent>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateSetting('dyslexia', 'dyslexicFont', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateSetting('dyslexia', 'textToSpeech', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateSetting('dyslexia', 'highlightReading', checked)}
                  />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateSetting('autism', 'predictableLayout', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateSetting('autism', 'visualSupports', checked)}
                  />
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateSetting('general', 'reducedAnimations', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateSetting('general', 'keyboardNavigation', checked)}
                  />
                </div>
              </div>
            </div>
