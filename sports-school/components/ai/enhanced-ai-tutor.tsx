...
export function EnhancedAITutor() {
  ...
  const generateAIResponse = async (message: string, tutor: AITutorPersonality) => {
    ...
    const responses = {
      newton: {
        content: "Great question! Let me break this down step by step. In mathematics, it's important to understand the underlying concepts first. Would you like me to show you a visual representation or work through a similar example?",
        followUp: ["Show me a visual example", "Work through a similar problem", "Explain the concept differently"]
      },
      curie: {
        content: "That's a fascinating scientific question! Let's explore this through experimentation. Science is all about curiosity and discovery. Have you observed this phenomenon in everyday life?",
        followUp: ["Tell me more about the experiment", "Show me real-world examples", "Explain the science behind it"]
      },
      shakespeare: {
        content: "Excellent! Language is such a powerful tool for expression. Let's dive into the beauty of words and how they can paint pictures in our minds. What aspect would you like to explore further?",
        followUp: ["Help me with writing", "Analyze this text", "Improve my vocabulary"]
      },
      timeline: {
        content: "What an interesting historical question! History is full of amazing stories and connections. Let me tell you about this fascinating period and how it connects to our world today.",
        followUp: ["Tell me more about this period", "How does this connect to today?", "Show me a timeline"]
      }
    };
    ...
    <div className="w-full max-w-6xl mx-auto space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Personalized learning with your AI tutor
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center p-3 bg-green-50 rounded-lg">
              ...
              <Badge variant={currentDifficulty === 'easy' ? 'secondary' : currentDifficulty === 'medium' ? 'default' : 'destructive'}>
                {currentDifficulty}
              </Badge>
            </div>
