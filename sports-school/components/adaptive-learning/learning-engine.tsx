    ...
    <div className="space-y-6">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Real-time difficulty adjustment engine that optimizes learning content based on student
          performance
        </p>
      </div>
        ...
        {modules.map((module) => (
          <Card key={module.id} className="hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardDescription>
                Difficulty Level:{' '}
                <span className={getDifficultyColor(module.currentDifficulty)}>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2 pt-2">
                <Button variant="outline" size="sm" onClick={() => handleModuleToggle(module.id)}>
                ...
                <Button variant="outline" size="sm" onClick={() => handleResetModule(module.id)}>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure how the AI engine adjusts difficulty levels</CardDescription>
        </CardHeader>
