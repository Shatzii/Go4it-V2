...
export default function GradeSummary({ userId, courseId, schoolTheme = 'superhero' }: GradeSummaryProps) {
  ...
  const themeGradeLabel = gradeLabels[schoolTheme][overallLetterGrade as keyof typeof gradeLabels.superhero];
              ...
              <div key={grade.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex items-center gap-3">
                  <div className="text-right">
                    <p className="font-bold">{grade.points}/{grade.maxPoints}</p>
                    <p className="text-sm text-gray-600">{grade.percentage.toFixed(1)}%</p>
                  </div>
                  <Badge className={themeColors[schoolTheme].secondary}>
                    {grade.letterGrade}
                  </Badge>
                </div>
              </div>
