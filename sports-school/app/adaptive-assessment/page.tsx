...
export default function AdaptiveAssessmentPage() {
  ...
  const getPerformanceAnalysis = () => {
    const accuracy =
      session.answers.length > 0 ? (session.score / session.answers.length) * 100 : 0;
    const avgTime =
      ...
      <header className="bg-black/20 backdrop-blur-sm border-b border-white/10">
        <div className="container mx-auto px-4 py-4">
          <nav className="flex justify-between items-center">
            <Link
              href="/"
              className="text-white font-bold text-xl hover:text-teal-300 transition-colors"
            >
              ← The Universal One School
            </Link>
            <div className="text-white font-bold text-xl">Adaptive Assessment Engine</div>
          </nav>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-8">
          ...
          <p className="text-teal-200">
            Real-time difficulty adjustment based on performance and learning patterns
          </p>
        </div>
        ...
        {!session.isActive && session.answers.length === 0 ? (
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setAssessmentSettings((prev) => ({ ...prev, subject: e.target.value }))
                    }
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setAssessmentSettings((prev) => ({ ...prev, gradeLevel: e.target.value }))
                    }
                    className="w-full p-2 rounded-lg bg-black/30 text-white border border-white/30 focus:border-teal-400"
                  >
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            if (e.target.checked) {
                              ...
                              setAssessmentSettings((prev) => ({
                                ...prev,
                                neurodivergentSupport: prev.neurodivergentSupport.filter(
                                  (s) => s !== option,
                                ),
                              }));
                            }
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-sm">
                      Questions adapt based on your performance and response time
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-sm">
                      Built-in support for ADHD, dyslexia, and autism needs
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-sm">
                      Immediate explanations and adaptive next steps
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="text-white/70">Difficulty: {session.difficultyLevel}/10</div>
            </div>
            ...
            {session.currentQuestion && (
              <div className="space-y-6">
                <div className="bg-black/20 p-6 rounded-lg">
                  ...
                  {session.currentQuestion.type === 'multiple-choice' &&
