...
export default function LanguageParentPortal() {
  ...
  const recentActivities = [
    {
      date: 'Today',
      activity: 'Completed Spanish Conversation Practice',
      type: 'speaking',
      score: 'Excellent',
    },
    {
      date: 'Yesterday',
      activity: 'Cultural Video: Mexican Traditions',
      type: 'culture',
      score: 'Watched',
    },
  ...
  const culturalEvents = [
    {
      date: 'Jan 30',
      event: 'Spanish Film Night',
      time: '6:00 PM',
      description: 'Family movie with subtitles',
    },
    {
      date: 'Feb 5',
      event: 'Cooking Class: Paella',
      time: '4:00 PM',
    ...
    },
    {
      ...
      event: 'Cultural Fair',
      time: '2:00 PM',
      description: 'Spanish-speaking countries showcase',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <Link
              ...
              className="text-white font-semibold text-lg hover:text-teal-300"
            >
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-lg text-teal-200">
                {studentData.primaryLanguage} • {studentData.level} Level
              </p>
                ...
                <div className="flex justify-between items-start mb-3">
                  <div>
                    ...
                    <p className="text-teal-200 text-sm">
                      {lang.level} • {lang.hours} hours studied
                    </p>
                  </div>
              ...
              <div>
                <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 rounded-lg p-6 mb-8">
                  ...
                  <p className="text-yellow-200 mb-4">
                    Access all platform content in your preferred language. Isabella's progress
                    reports and assignments can be translated to help you stay engaged in her
                    learning journey.
                  </p>
                ...
                <div className="space-y-4">
                  <div className="bg-white/5 rounded-lg p-6 border border-white/10">
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <span className="bg-teal-500/30 text-teal-200 px-2 py-1 rounded text-xs">
                        Progress Update
                      </span>
                    </div>
                    <p className="text-white mb-3">
                      Isabella showed excellent progress in today's conversation practice. Her
                      confidence in speaking Spanish has noticeably improved!
                    </p>
                    <button className="bg-teal-600 text-white px-4 py-2 rounded hover:bg-teal-700">
                  ...
                  <div className="bg-white/5 rounded-lg p-6 border border-white/10">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        <h4 className="text-white font-semibold">
                          From: Cultural Activities Coordinator
                        </h4>
                    ...
                    <p className="text-white mb-3">
                      We're excited to invite your family to our upcoming Spanish Film Night.
                      Isabella has been selected to help introduce the movie!
                    </p>
