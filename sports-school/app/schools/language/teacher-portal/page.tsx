        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <Link
              ...
              className="text-white font-semibold text-lg hover:text-emerald-300"
            >
                        ...
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <div className="text-emerald-200 text-sm">
                              {index === 0
                                ? '68 students • 4 levels'
                                : index === 1
                                  ? '35 students • 3 levels'
                      ...
                      <div key={index} className="bg-white/5 rounded-lg p-4 border border-white/10">
                        ...
                        <div className="flex justify-between text-sm">
                          <span className="text-white">
                            Completion: {lesson.completed}/{lesson.scheduled}
                          </span>
                          <span className="text-emerald-300">
                            {Math.round((lesson.completed / lesson.scheduled) * 100)}%
                          </span>
                        </div>
                      </div>
                    ))}
                      ...
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="text-right">
                          <div className="text-2xl font-bold text-white">
                            {lesson.completed}/{lesson.scheduled}
                          </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        ...
                        <p className="text-emerald-200 text-sm">
                          Foreign films with subtitles and discussion groups
                        </p>
                      </div>
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        ...
                        <p className="text-emerald-200 text-sm">
                          Traditional recipes while practicing vocabulary
                        </p>
                      </div>
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        ...
                        <p className="text-emerald-200 text-sm">
                          Native speaker sessions and peer practice
                        </p>
                      </div>
                    </div>
                  </div>
