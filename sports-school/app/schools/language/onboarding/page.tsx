          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                Liota Global Language Academy Onboarding
              </h1>
              <p className="text-gray-600">
                Create immersive multilingual schedules for grades 9-12
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <p>
                    <span className="font-medium">Cultural Interests:</span>{' '}
        ...
        {generatedSchedule && (
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="mb-6">
              ...
              <p className="text-green-600 font-medium">
                Target Language: {generatedSchedule.weekly_schedule[0]?.target_language}
              </p>
            </div>
