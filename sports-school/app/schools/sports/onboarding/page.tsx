          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Create elite athletic-academic schedules for grades 9-12
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-3">
                  Athletic Strengths & Development
                </h3>
                <div className="space-y-2 text-sm">
                  <p>
                  ...
                  <p>
                    <span className="font-medium">Sports Interests:</span>{' '}
              ...
              {generatedSchedule.weekly_schedule.map((period: any, index: number) => (
                <div key={index} className="border border-red-100 rounded-lg p-4">
                  ...
                  <div className="text-sm text-gray-600 mb-2">
                    <p>
                      <span className="font-medium">Coach:</span> {period.teacher_name}
                    </p>
                  </div>
