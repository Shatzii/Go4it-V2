...
export default function SecondaryStudentDashboard() {
  ...
  const achievements = [
    { title: 'Outstanding Scholar', description: 'Exceptional work in advanced mathematics', icon: Star, earned: true },
    { title: 'Research Excellence', description: 'Mastered scientific research methodology', icon: Trophy, earned: true },
    { title: 'Academic Leadership', description: 'Led student study groups', icon: GraduationCap, earned: false },
    { title: 'Community Service Award', description: 'Mentored younger students', icon: Award, earned: true }
  ]

  const aiTeachersAvailable = [
    { name: 'Ms. Shakespeare', subject: 'Literature & Writing', status: 'online', personality: 'Passionate about storytelling and critical analysis' },
    { name: 'Professor Newton', subject: 'Mathematics & Physics', status: 'online', personality: 'Methodical approach to problem-solving' },
    { name: 'Dr. Curie', subject: 'Science & Research', status: 'busy', personality: 'Encourages scientific curiosity and experimentation' },
    { name: 'Dr. Inclusive', subject: 'Learning Support', status: 'online', personality: 'Helps with study strategies and academic confidence' }
  ]
        ...
        <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 text-white rounded-lg p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-purple-100 mt-1">Strategic Teaching for Academic Growth & Excellence - Grade {currentGrade}</p>
            </div>
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between text-sm mb-2">
              ...
              <span>{academicProgress.achievementPoints}/{academicProgress.nextLevelPoints} Points</span>
            </div>
            <Progress value={(academicProgress.achievementPoints / academicProgress.nextLevelPoints) * 100} className="h-2 bg-purple-800" />
          </div>
        </div>
