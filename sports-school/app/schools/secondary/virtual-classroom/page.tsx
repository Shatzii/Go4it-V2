      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 text-white rounded-lg p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold">Virtual Rehearsal Room 🎭</h1>
                  ...
                  <CardContent>
                    ...
                    <div className="aspect-video bg-gradient-to-br from-purple-900 to-pink-900 rounded-lg flex items-center justify-center mb-4">
                      <div className="text-center text-white">
                        ...
                        <h3 className="text-xl font-semibold mb-2">Ms. Shakespeare</h3>
                        <p className="text-purple-200">Teaching Romeo and Juliet</p>
                      </div>
                    </div>
