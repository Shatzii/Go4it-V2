...
export default function PrimaryStudentDashboard() {
  ...
  const todaysQuests = [
    {
      title: 'Math Adventure: Multiplication Tables',
      subject: 'Math',
      progress: 75,
      difficulty: 'easy',
    },
    ...
    {
      title: 'Science Mission: Plant Growth',
      subject: 'Science',
      progress: 90,
      difficulty: 'hard',
    },
  ...
  const aiTeachersAvailable = [
    {
      ...
      subject: 'Math Magic',
      status: 'online',
      personality: 'Patient teacher who makes math fun!',
    },
    {
      name: 'Dr. Curie',
      subject: 'Science Adventures',
      status: 'online',
      personality: 'Curious explorer who loves experiments!',
    },
    {
      name: 'Ms. Shakespeare',
      subject: 'Story Time',
      status: 'busy',
      personality: 'Creative writer who tells amazing stories!',
    },
    {
      name: 'Maestro Picasso',
      subject: 'Art Fun',
      status: 'online',
      personality: 'Colorful artist who teaches creativity!',
    },
  ];
        ...
        <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white rounded-lg p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-100 mt-1">
                SuperHero Learning Academy - Grade {currentGrade}
              </p>
            </div>
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between text-sm mb-2">
              ...
              <span>
                {superheroProgress.xp}/{superheroProgress.nextLevel} XP
              </span>
            </div>
            <Progress
              value={(superheroProgress.xp / superheroProgress.nextLevel) * 100}
