...
export default function PrimaryVirtualClassroom() {
  ...
  const chatMessages = [
    {
      user: 'Professor Newton',
      message: '🦸‍♂️ Welcome to our Math Adventure!',
      time: '2:15 PM',
      avatar: '👨‍🏫',
    },
    {
      user: 'Tommy Super Student',
      message: '🚀 Ready to solve multiplication problems!',
      time: '2:16 PM',
      avatar: '🦸‍♂️',
    },
    ...
    {
      user: 'Professor Newton',
      message: "🎯 Let's start with our superhero math powers!",
      time: '2:18 PM',
      avatar: '👨‍🏫',
    },
  ];
                    ...
                    <div className="space-y-2">
                      {participants.map((participant, index) => (
                        <div key={index} className="flex items-center gap-2 p-2 rounded bg-blue-50">
                          ...
                          {participant.speaking && <span className="text-sm">🗣️</span>}
                          <div
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 border-2 border-dashed border-purple-300 rounded-lg text-center bg-purple-50">
                  ...
                  <p className="text-xs text-purple-600 mb-3">
                    Upload your assignments and projects
                  </p>
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 mb-4">
                    Your amazing class adventures will appear here so you can watch them again! 🎬
                  </p>
          ...
          <CardContent className="p-6">
            <div className="text-center">
              <h3 className="font-medium text-blue-800 mb-4">
                Need Help with Your Virtual Classroom? 🤔
              </h3>
