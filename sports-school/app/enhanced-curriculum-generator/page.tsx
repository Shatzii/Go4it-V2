...
export default function EnhancedCurriculumGenerator() {
  ...
  const [viewMode, setViewMode] = useState<'generator' | 'library' | 'builder' | 'preview'>(
    'generator',
  );
  ...
  const sampleResources: ResourceItem[] = [
    {
      ...
      description:
        'Interactive video series covering core math concepts with visual aids and practice problems',
    ...
    },
    {
      ...
      description:
        'Adaptive learning game that adjusts to student skill level with curriculum alignment',
    ...
    },
    {
      ...
      description:
        'Educational content with high-quality photography, videos, and interactive maps',
    ...
    },
    {
      ...
      description:
        'Visual programming language for creating interactive stories, games, and animations',
      ...
      assessments: [
        {
          ...
          rubric: [
            ...
            'Shows good progress with minor gaps',
        ...
        },
        {
          ...
          rubric: [
            ...
            'Meets all grade-level standards',
        ...
        },
        {
          ...
          description:
            "Students work together to solve problems and assess each other's contributions",
          rubric: [
            'Excellent collaboration and problem-solving',
            'Good teamwork with solid contributions',
            'Basic participation with guidance needed',
          ],
        },
      ],
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Create personalized, multimedia-rich learning experiences with neurodivergent
            adaptations
          </p>
        </div>
            ...
            <Card className="shadow-xl border-0 bg-gradient-to-r from-indigo-500 to-purple-600 text-white">
              <CardHeader>
                ...
                <CardDescription className="text-indigo-100">
                  Generate comprehensive curriculum with multimedia resources and neurodivergent
                  adaptations
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <Card key={resource.id} className="shadow-md hover:shadow-lg transition-shadow">
                      <div className="relative">
                        <div className="h-48 bg-gradient-to-br from-blue-100 to-purple-100 rounded-t-lg flex items-center justify-center">
                          <div
                            className={`p-4 rounded-full ${getResourceColor(resource.type)} text-white`}
                          >
                            {getResourceIcon(resource.type)}
                          </div>
                        </div>
                        <Badge
                          className={`absolute top-2 right-2 ${getResourceColor(resource.type)} text-white`}
                        >
          ...
          <div className="space-y-6">
            <Card className="shadow-xl">
              <CardHeader className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-t-lg">
                ...
                <CardDescription className="text-indigo-100">
                  Duration: {generatedCurriculum.duration} minutes •{' '}
                  {generatedCurriculum.difficulty} level
                </CardDescription>
                <div className="flex gap-4 mt-4">
                          ...
                          <CardContent className="p-4">
                            <div className="flex items-start justify-between">
                              <div className="flex items-start gap-3">
                                <div
                                  className={`p-2 rounded-lg ${getResourceColor(resource.type)} text-white`}
                                >
                                  {getResourceIcon(resource.type)}
                                </div>
                                <div>
