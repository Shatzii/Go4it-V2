...
export default function Page() {
  ...
  const schools = [
    {
      ...
      description: 'K-6 students discover their learning superpowers through engaging, gamified education that transforms every lesson into an adventure.',
      ...
      features: ['Gamified Learning', 'Character Development', 'Creative Problem Solving', 'Social Skills'],
      link: '/schools/primary'
    },
    {
      id: 'secondary',
      name: 'S.T.A.G.E Prep Academy',
      description: 'Academic excellence program preparing students for college and career success through rigorous coursework and leadership development.',
      ...
      features: ['Advanced Placement', 'College Preparation', 'Leadership Development', 'Critical Thinking'],
      link: '/schools/secondary'
    },
    {
      id: 'law',
      name: 'Future Legal Professionals',
      description: 'Specialized program for aspiring lawyers, judges, and legal professionals with comprehensive law education and practical experience.',
      grades: 'Law School',
      students: '800+',
      theme: 'Justice & Law',
      icon: Shield,
    ...
    },
    {
      ...
      description: 'Immersive multilingual education connecting students to world cultures through authentic language experiences and cultural exchange.',
      grades: 'All Ages',
      students: '1,500+',
    ...
    },
    {
      ...
      description: 'Athletic excellence combined with academic achievement and character building through comprehensive sports science and training.',
      grades: 'K-12',
      students: '1,150+',
      ...
      features: ['Olympic Training', 'Sports Science', 'Nutrition Education', 'Mental Conditioning'],
  ...
  const aiTeachers = [
    ...
    { name: 'Professor Timeline', subject: 'Social Studies', icon: BookOpen, color: 'text-orange-600' },
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Five specialized academies designed to nurture every student's unique talents and aspirations
          </p>
        </div>
              ...
              >
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {school.features.map((feature, idx) => (
                        <div key={idx} className="flex items-center text-gray-700 bg-white/70 rounded-lg p-3">
                  ...
                  <Link href={school.link}>
                    <Button className={`w-full bg-gradient-to-r ${school.color} hover:scale-105 transition-all duration-300 text-white font-semibold py-3 text-lg shadow-lg`}>
                      Explore {school.name}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Meet our six specialized AI teachers, each with unique personalities and teaching approaches
            </p>
          </div>
