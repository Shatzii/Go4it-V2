...
function generatePersonalizedMessages(targetType: string) {
  const messageTemplates = {
    students: {
      discovery:
        'Have you ever wondered what it would be like to learn in a way that actually works with your brain instead of against it?',
      engagement:
        'Your journey reminds me of Sarah, one of our students who went from struggling with traditional math to becoming a coding champion.',
      conversion:
        'Ready to discover your learning superpower? Our AI creates a personalized learning path just for you.',
    },
    parents: {
      discovery:
        'I understand the frustration of watching your brilliant child struggle in traditional classrooms.',
      engagement:
        "What if your child's learning difference isn't seen as a problem to fix, but as a unique strength to celebrate?",
      conversion:
        'Ready to see your child thrive? Our AI-powered education adapts to exactly how their amazing brain works.',
    },
    teachers: {
      discovery:
        "Your passion for innovative education caught my attention - it's exactly what we value at Universal One School.",
      engagement:
        "What if you could teach where your creativity isn't constrained by standardized testing?",
      conversion:
        "Ready to revolutionize education? We're looking for passionate educators. Plus, 70% revenue share on courses you create!",
    },
    coaches: {
      discovery:
        "Your coaching methodology is impressive. I'm particularly interested in your approach to athlete development.",
      engagement:
        'What if you could work with student-athletes who maintain a 4.2 GPA while training at Olympic levels?',
      conversion:
        "Ready to develop tomorrow's champions? Our academy has produced 23 Olympic athletes and 156 D1 scholarships.",
    },
  };
