...
function generateUnits(subject: string, gradeLevel: string, accommodations: string[]) {
  const baseUnits = {
    ...
    Science: ['Scientific Method', 'Life Science', 'Physical Science', 'Earth & Space Science'],
    'Social Studies': ['Community & Culture', 'Geography', 'History', 'Civics & Government'],
  };

  const units = baseUnits[subject as keyof typeof baseUnits] || [
    'Unit 1',
    'Unit 2',
    'Unit 3',
    'Unit 4',
