            ...
            <div className="p-4">
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <span
                      className={`px-2 py-1 text-xs font-medium rounded-full ${
                        contentTypes.find((t) => t.id === item.type)?.color ||
                  ...
                  {item.views && <p className="text-sm text-gray-500 mt-1">{item.views} views</p>}
                </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          ...
          {
            name: 'Course Card',
            description: 'Display course information with enrollment',
            category: 'Educational',
          },
          {
            name: 'Student Progress',
            description: 'Visual progress tracking widget',
            category: 'Analytics',
          },
          {
            name: 'AI Tutor Chat',
            description: 'Interactive AI conversation widget',
            category: 'AI Features',
          },
          {
            name: 'Social Media Feed',
            description: 'Display recent social activity safely',
            category: 'Social',
          },
          {
            name: 'Achievement Badge',
            description: 'Show student achievements and badges',
