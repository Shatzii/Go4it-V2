      ...
      items: [
        {
          ...
          icon: Shield,
          description: 'K-6 superhero-themed education with AI support',
        },
        {
          name: 'S.T.A.G.E Prep Global Academy',
          href: '/schools/secondary',
          icon: Target,
          description: '7-12 global academy with 5 career programs',
        },
        {
          name: 'Law School',
          href: '/schools/law',
        ...
        },
        {
          ...
          icon: Globe,
          description: 'Multilingual education with 15+ languages',
        },
        {
          name: 'Go4it Sports Academy',
          href: '/schools/go4it-sports-academy',
          icon: Trophy,
          description: 'Elite athletic training at $95M Vienna campus',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: Users,
          description: 'Assignments, grades, progress tracking',
        },
        {
          name: 'Parent Portal',
          href: '/parent-portal',
          icon: Heart,
          description: 'Child progress, billing, safety monitoring',
        },
        {
          name: 'Teacher Portal',
          href: '/teacher-portal',
          icon: BookOpen,
          description: 'Class management, grading, tools',
        },
        {
      ...
      items: [
        {
          ...
          icon: Archive,
          description: 'Pre-built curriculum database',
        },
        {
          name: 'Assessment Tools',
          href: '/assessment-tools',
          icon: FileText,
          description: 'Comprehensive testing and evaluation',
        },
        {
        ...
        },
        {
          ...
          href: '/grade-book',
          icon: BookOpen,
          description: 'Digital grade management',
        },
        {
          name: 'Assignment Center',
          href: '/assignment-center',
          icon: Folder,
        ...
        },
        {
          ...
          icon: FileText,
          description: 'Educational materials library',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          href: '/class-forums',
          icon: MessageCircle,
          description: 'Discussion boards for classes',
        },
        {
          name: 'Announcements',
          href: '/announcements',
        ...
        },
        {
          ...
          icon: Calendar,
          description: 'Synchronized scheduling',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: Eye,
          description: 'AI-powered safety oversight',
        },
        {
        ...
        },
        {
          ...
          icon: UserPlus,
          description: 'Secure visitor check-in system',
        },
        {
          name: 'Access Control',
          href: '/access-control',
        ...
        },
        {
          ...
          icon: FileText,
          description: 'Document safety incidents',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: DollarSign,
          description: 'Budget and finance tracking',
        },
        {
          name: 'Parent Engagement',
          href: '/parent-engagement',
          icon: Heart,
          description: 'Parent involvement metrics',
        },
        {
      ...
      items: [
        {
          ...
          href: '/tuition-management',
          icon: DollarSign,
          description: 'Automated tuition billing',
        },
        {
        ...
        },
        {
          ...
          href: '/fee-tracking',
          icon: Coins,
          description: 'Track additional fees and charges',
        },
        {
          name: 'Financial Aid',
          href: '/financial-aid',
          icon: Heart,
          description: 'Scholarship and aid management',
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: Glasses,
          description: 'Accessibility tools and features',
        },
        {
        ...
        },
        {
          ...
          href: '/adaptive-interfaces',
          icon: Monitor,
          description: 'Customizable user interfaces',
        },
        {
          name: 'Sensory Support',
          href: '/sensory-support',
          icon: Volume,
          description: 'Visual and auditory accommodations',
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          name: 'AI Research Projects',
          href: '/ai-research',
          icon: TestTube,
          description: 'Student AI research initiatives',
        },
        {
          name: 'Robotics Programs',
          href: '/robotics',
          icon: Wrench,
          description: 'Hands-on robotics education',
        },
        {
          name: 'Space Science',
          href: '/space-science',
        ...
        },
        {
          ...
          href: '/biotechnology',
          icon: Microscope,
          description: 'Modern biological research',
        },
        {
          name: 'Innovation Labs',
          href: '/innovation-labs',
          icon: Lightbulb,
          description: 'Creative technology projects',
        },
      ],
    },
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Explore our comprehensive AI-powered educational platform with 50+ features across 5
                specialized schools, supporting all learning styles and needs.
              </p>
            </div>
          </div>
        </div>
