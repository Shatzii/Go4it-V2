...
export default function StudentOnboarding() {
  ...
  const steps = ['Select Student', 'Review Profile', 'Generate Schedule', 'Review & Confirm'];
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg">
                          {selectedStudent.school.charAt(0).toUpperCase() +
                            selectedStudent.school.slice(1)}{' '}
                          School
                        </p>
                      </div>
                      <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="text-center">
                          <div className="text-2xl font-bold text-purple-600">
                            {generatedSchedule.meets_texas_requirements
                              ? 'Compliant'
                              : 'Non-Compliant'}
                          </div>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {generatedSchedule.weekly_schedule[0].periods.map(
          ...
          {currentStep === 3 && selectedStudent && generatedSchedule && (
            <div>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 mb-6">
                  {selectedStudent.name}'s personalized schedule has been created and meets all
                  Texas TEKS requirements.
                </p>
                <div className="bg-green-50 p-4 rounded-lg mb-6">
                  <p className="text-green-800 font-medium">{generatedSchedule.compliance_notes}</p>
                </div>
                <div className="flex justify-center gap-4">
                  <Button variant="outline">Download Schedule</Button>
                  <Button className="bg-blue-600 hover:bg-blue-700">Enroll Student</Button>
                </div>
              </div>
            </div>
          )}
