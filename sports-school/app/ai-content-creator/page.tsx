      ...
      <header className="bg-black/20 backdrop-blur-sm border-b border-white/10">
        <div className="container mx-auto px-4 py-4">
          <nav className="flex justify-between items-center">
            <Link
              href="/"
              className="text-white font-bold text-xl hover:text-indigo-300 transition-colors"
            >
              ← The Universal One School
            </Link>
            <div className="text-white font-bold text-xl">AI Content Creator</div>
          </nav>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="mb-8">
          ...
          <p className="text-indigo-200">
            Generate personalized learning materials with neurodivergent adaptations
          </p>
        </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {contentTypes.map((type) => (
                    <button
                      key={type.value}
                      onClick={() =>
                        setContentRequest((prev) => ({ ...prev, type: type.value as any }))
                      }
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setContentRequest((prev) => ({ ...prev, subject: e.target.value }))
                    }
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setContentRequest((prev) => ({ ...prev, gradeLevel: e.target.value }))
                    }
                    className="w-full p-2 rounded-lg bg-black/30 text-white border border-white/30 focus:border-indigo-400"
                  >
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setContentRequest((prev) => ({ ...prev, duration: parseInt(e.target.value) }))
                    }
                    className="w-full p-2 rounded-lg bg-black/30 text-white border border-white/30 focus:border-indigo-400"
                    min="15"
                    max="180"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setContentRequest((prev) => ({ ...prev, difficulty: e.target.value as any }))
                    }
                    className="w-full p-2 rounded-lg bg-black/30 text-white border border-white/30 focus:border-indigo-400"
                  >
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            ...
            {isGenerating ? (
              ...
              <div className="text-center py-12 text-white/60">
                ...
                <p>
                  Fill out the form and click "Generate AI Content" to create personalized learning
                  materials
                </p>
              </div>
            )}
