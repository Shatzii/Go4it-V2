...
export function registerRoutes(app: Express): Server {
  ...
  // Self-hosted AI testing and monitoring endpoints
  import selfHostedAIRoutes from './routes/self-hosted-ai-test.js';
  app.use('/api/ai/self-hosted', selfHostedAIRoutes);
