...
const testCases = [
  ...
  { sport: 'basketball', region: 'Europe', gender: 'women', name: 'Basketball Women\'s Europe Top 100' },
...
async function runComprehensiveTest() {
  ...
  for (const testCase of testCases) {
    ...
    console.log(`   ${status} ${result.name}: ${result.athletes} athletes (${result.totalProcessed} processed)`);
