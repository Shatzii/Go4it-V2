...
export default function ParentAnalytics() {
  ...
  const [selectedMetric, setSelectedMetric] = useState<
    'grades' | 'attendance' | 'participation' | 'assignments'
  >('grades');
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
          {Object.entries(analyticsData.metrics).map(([key, metric]) => (
            <div key={key} className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="text-xs text-gray-500 mt-1">Previous: {metric.previous}%</div>
            </div>
          ))}
        </div>
                ...
                {analyticsData.goalProgress.map((goal, idx) => (
                  <div key={idx} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <span
                        className={`px-2 py-1 text-xs rounded-full ${getStatusColor(goal.status)}`}
                      >
                        {goal.status.replace('-', ' ')}
                      </span>
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700 mt-1">
                        Math performance has improved 7% this month. Consistent practice is showing
                        results.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700 mt-1">
                        Emma is ahead of schedule on her math goal and may be ready for advanced
                        challenges.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-700 mt-1">
                        Reading goal progress is slightly behind. Consider increasing daily reading
                        time.
                      </p>
                    </div>
                  </div>
