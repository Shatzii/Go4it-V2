                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <Badge
                        className={`${school.division === 'D1' ? 'bg-green-500' : school.division === 'D2' ? 'bg-yellow-500' : 'bg-blue-500'} text-white`}
                      >
                        {school.division}
                      </Badge>
                  ...
                  <div
                    className={`w-3 h-3 rounded-full ${getConfidenceColor(school.contactStatus.confidence)}`}
                    title={`Contact confidence: ${school.contactStatus.confidence}`}
                  ></div>
                </div>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    <Button size="sm" className="flex-1" onClick={() => setSelectedSchool(school)}>
                      View Details
                    </Button>
                    <Button
                      size="sm"
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <Badge
                        className={`${selectedSchool.division === 'D1' ? 'bg-green-500' : selectedSchool.division === 'D2' ? 'bg-yellow-500' : 'bg-blue-500'} text-white`}
                      >
                      ...
                      <Badge
                        className={`${getConfidenceColor(selectedSchool.contactStatus.confidence)} text-white`}
                      >
              ...
              <CardContent>
                <Tabs defaultValue="contacts" className="space-y-4">
                        ...
                        <CardContent>
                          <div className="space-y-3">
                            <div className="text-white font-medium">
                              {selectedSchool.athleticDirector.name}
                            </div>
                            <div className="flex items-center gap-2 text-slate-300">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-2 text-slate-300">
                              ...
                              <span>
                                Verified:{' '}
                                {new Date(
                                  selectedSchool.contactStatus.lastVerified,
                                ).toLocaleDateString()}
                              </span>
                            </div>
                            <Button
                  ...
                  <TabsContent value="coaching" className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {Object.entries(selectedSchool.coachingStaff).map(
                        ([sport, staff]: [string, any]) => (
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                      {selectedSchool.programs.map((program) => (
                        <Badge
                          key={program}
                          variant="secondary"
                          className="justify-center p-2 capitalize"
                        >
                          {program}
                        </Badge>
                      ))}
