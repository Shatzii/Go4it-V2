...
const initialMediaItems: MediaItem[] = [
  {
    ...
    category: 'marketing',
    description:
      'Comprehensive GAR rating system breakdown showing Physical (80%), Cognitive (20%), and Psychological (20%) components',
  ...
  },
  {
    ...
    category: 'events',
    description:
      'International combine tour map showing Atlanta, Vienna, Mexico City, and Paris locations',
                ...
                <CardContent className="p-4">
                  ...
                  <div className="aspect-video bg-slate-700 rounded-lg mb-4 relative overflow-hidden">
                    ...
                    <div className="absolute top-2 right-2">
                      <Badge
                        className={`${item.type === 'image' ? 'bg-green-500' : item.type === 'video' ? 'bg-blue-500' : 'bg-purple-500'} text-white`}
                      >
                        {item.type}
                      </Badge>
                    </div>
