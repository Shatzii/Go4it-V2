...
export async function POST(request: NextRequest) {
  try {
    ...
    if (incomingMessage.includes('subscribe') || incomingMessage.includes('join')) {
      ...
      twiml.message('🔥 Welcome to Go4It Sports notifications! You\'ll receive updates about scores, achievements, and more. Text STOP to unsubscribe anytime.');
    ...
    const twiml = new MessagingResponse();
    twiml.message('Sorry, we\'re experiencing technical difficulties. Please try again later or visit go4it.app');
