...
const REAL_ATHLETIC_CONTACTS = [
  {
    ...
    programs: ['football', 'basketball', 'baseball', 'softball', 'track', 'soccer', 'tennis', 'golf', 'swimming', 'gymnastics']
  },
  {
    ...
    programs: ['football', 'basketball', 'baseball', 'softball', 'track', 'soccer', 'tennis', 'golf', 'swimming', 'wrestling']
  },
  {
    ...
    programs: ['football', 'basketball', 'baseball', 'softball', 'track', 'soccer', 'tennis', 'golf', 'swimming']
  },
  {
    ...
    programs: ['football', 'basketball', 'baseball', 'softball', 'track', 'soccer', 'tennis', 'golf', 'swimming', 'volleyball']
  },
  {
    ...
    programs: ['football', 'basketball', 'baseball', 'softball', 'track', 'soccer', 'tennis', 'golf', 'swimming', 'hockey']
  },
  {
  ...
  },
  {
    ...
    programs: ['football', 'basketball', 'baseball', 'softball', 'track', 'soccer', 'tennis', 'golf', 'swimming', 'lacrosse']
  },
  {
...
const D2_SCHOOLS = [
  ...
  },
  {
    ...
    programs: ['football', 'basketball', 'baseball', 'softball', 'track', 'soccer', 'tennis', 'golf']
  }
];
...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { error: 'Failed to fetch athletic contacts' },
      { status: 500 }
    );
  }
}
