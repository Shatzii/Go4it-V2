...
export default function BasketballRegisterPage() {
  ...
  const divisions = [
    ...
    { id: 'u12', name: 'U12', ages: '11-12 years', available: true, cost: 210 },
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="flex items-center mb-4">
            ...
            <Badge variant="outline" className="text-white border-white">
              Fundamental Training Basketball Program
            </Badge>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              ...
              <CardDescription className="text-slate-400">
                Tell us about the player who will be joining the basketball team
              </CardDescription>
            </CardHeader>
        ...
        {/* Step 2: Parent/Guardian Info - Similar to other sports */}
        {currentStep === 2 && (
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              <CardTitle className="text-white flex items-center">
        ...
        {currentStep === 3 && (
          <Card className="bg-slate-800 border-slate-700">
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                <Label className="text-white">Previous Basketball Experience</Label>
                <Select onValueChange={(value) => updateFormData('experience', value)}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="school">School team experience</SelectItem>
                    <SelectItem value="aau">AAU or travel team experience</SelectItem>
