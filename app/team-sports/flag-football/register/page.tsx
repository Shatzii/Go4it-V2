          ...
          <Card className="bg-green-600 border-green-500 text-center">
            <CardContent className="p-8">
              ...
              <p className="text-green-100 mb-6">
                Welcome to the Go4It Sports Flag Football program! You'll receive team assignment
                and practice schedule information via email within 48 hours.
              </p>
              <div className="space-y-2 text-green-100">
                <p>
                  <strong>Registration ID:</strong> FF-{Date.now()}
                </p>
                <p>
