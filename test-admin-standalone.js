...
try {
  ...
  if (
    adminPageResult.includes('Go4It Sports Admin') &&
    adminPageResult.includes('Platform Administration')
  ) {
  ...
  if (
    adminPageResult.includes('Standalone Admin Header') ||
    adminPageResult.includes('Back to Site')
  ) {
