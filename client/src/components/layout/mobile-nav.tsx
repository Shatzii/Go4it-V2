          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-5 gap-4 mb-6">
              ...
              <Link href="/whiteboard">
                <div className="flex flex-col items-center" onClick={() => setShowMoreMenu(false)}>
                  <div className={`rounded-full p-3 ${location === "/whiteboard" || location.startsWith("/whiteboard/") ? "bg-cyan-500 text-white" : "bg-gray-700 text-gray-200"}`}>
                  ...
                  <span className="text-xs mt-2 text-center text-white font-medium">Strategy</span>
                </div>
              </Link>
