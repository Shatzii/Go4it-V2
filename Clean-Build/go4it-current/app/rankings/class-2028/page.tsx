    ...
    const athletes = [
      {
        ...
        ranking: 1,
        gpa: 3.7,
        offers: ['USC', 'Arizona', 'Kansas', 'UCLA'],
      },
      {
        name: 'Kiyan Anthony',
        position: 'SG',
        ...
        ranking: 2,
        gpa: 3.6,
        offers: ['Syracuse', 'USC', 'Auburn', 'UConn'],
      },
      {
      ...
      },
      {
        ...
        ranking: 5,
        gpa: 3.6,
        offers: ['UCLA', 'USC', 'Oregon'],
      },
      {
        name: 'Keaton Wallace',
        position: 'SG',
        school: 'Richardson HS',
        state: 'TX',
        sport: 'Basketball',
        ranking: 6,
        gpa: 3.7,
        offers: ['Texas', 'Houston', 'Baylor'],
      },
      {
        name: 'Johnuel Fland',
        position: 'PG',
      ...
      {
        name: 'Jordan Washington Jr',
        position: 'SF',
        school: 'Gary West Side',
        state: 'IN',
        sport: 'Basketball',
        ranking: 8,
        gpa: 3.5,
      ...
      },
      {
        ...
        ranking: 11,
        gpa: 3.5,
        offers: ['Arizona State', 'Arizona', 'UNLV'],
      },
      {
        name: 'Acaden Lewis',
        position: 'PG',
      ...
      },
      {
        ...
        ranking: 13,
        gpa: 3.6,
        offers: ['Indiana', 'Michigan', 'Ohio State'],
      },
      {
        name: 'Jamir Watkins',
        position: 'SF',
        ...
        ranking: 14,
        gpa: 3.4,
        offers: ['Florida State', 'VCU', 'Virginia Tech'],
      },
      {
        name: 'Tae Davis',
        position: 'PF',
        ...
        ranking: 15,
        gpa: 3.5,
        offers: ['Arizona', 'UCLA', 'USC'],
      },
      {
        name: 'Rayvon Griffith',
        position: 'SG',
      ...
      },
      {
        ...
        ranking: 17,
        gpa: 3.3,
        offers: ['Auburn', 'Alabama', 'Tennessee'],
      },
      {
        name: 'Jalil Bethea',
        position: 'PG',
        ...
        ranking: 18,
        gpa: 3.8,
        offers: ['Miami', 'Rutgers', 'Seton Hall'],
      },
      {
        ...
        ranking: 19,
        gpa: 3.5,
        offers: ['Virginia', 'VCU', 'Virginia Tech'],
      },
      {
        name: 'Zion Cruz',
        position: 'PF',
        ...
        ranking: 20,
        gpa: 3.6,
        offers: ['DePaul', 'Rutgers', 'Seton Hall'],
      },
      {
        ...
        ranking: 21,
        gpa: 3.7,
        offers: ['Maryland', 'Georgetown', 'Virginia'],
      },
      {
        name: 'Malik Dia',
        position: 'C',
        school: 'Putnam Science Academy',
        state: 'CT',
        sport: 'Basketball',
        ranking: 22,
        gpa: 3.4,
        offers: ['Belmont', 'VCU', 'George Mason'],
      },
      {
        name: 'Chris Cenac Jr',
        position: 'C',
      ...
      },
      {
        ...
        ranking: 24,
        gpa: 3.3,
        offers: ['Arkansas', 'Auburn', 'Texas Tech'],
      },
      {
        name: 'Derek Dixon',
        position: 'PF',
