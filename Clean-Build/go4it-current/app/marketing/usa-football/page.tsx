    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <section className="hero-bg py-20 px-4 text-center relative overflow-hidden">
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="mb-4">
            <span className="neon-text text-lg font-semibold tracking-wider uppercase">
              Official USA Football Partnership
            </span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-slate-300 mb-8 max-w-4xl mx-auto leading-relaxed font-medium">
            Official USA Football credentials + 6-month Go4It platform access. Your first step
            toward American football opportunities.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold neon-text mb-4">
              Mexico Tour + USA Football Partnership
            </h2>
            <p className="text-xl text-slate-400">
              Official credentials that open doors to American football
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="hero-bg neon-border rounded-xl p-8 relative overflow-hidden">
              ...
              <div className="mb-8">
                ...
                <div className="text-lg text-slate-300">
                  + $35 USA Football Membership (normally $119)
                </div>
              </div>
              ...
              <a
                ...
                className="w-full glow-button text-center py-3 inline-block"
              >
            ...
            <div className="hero-bg neon-border rounded-xl p-8 relative overflow-hidden border-purple-500">
              ...
              <div className="mb-8">
                ...
                <div className="text-lg text-slate-300">
                  + $75 Combined USA Football Package (normally $294)
                </div>
              </div>
              ...
              <a
                href="/camp-registration"
                className="w-full bg-purple-600 hover:bg-purple-700 text-white text-center py-3 rounded-lg font-bold transition-colors inline-block"
              >
      ...
      <section className="py-16 px-4 bg-slate-800/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-400">
              NFL veterans and USA Football certified coaches
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-slate-800/50 backdrop-blur neon-border rounded-lg p-8">
              ...
              <p className="text-slate-300 mb-4">
                Former NFL safety with championship experience. Now bringing elite American football
                training to Mexico through our partnership programs.
              </p>
            ...
            <div className="bg-slate-800/50 backdrop-blur neon-border rounded-lg p-8">
              ...
              <p className="text-slate-300 mb-4">
                Former Chicago Bears player and Head Coach of Spanish National Team for 3 years. Led
                Spain to its first international victory.
              </p>
              <div className="text-sm text-slate-400">
            ...
            <div className="grid md:grid-cols-2 gap-8 text-left">
              <div>
                ...
                <p className="text-slate-300 mb-6">
                  USA Football is the official development partner of the NFL. Your membership
                  provides verified credentials recognized by American colleges and professional
                  scouts.
                </p>

                <h3 className="text-xl font-bold text-purple-400 mb-4">Insurance Protection</h3>
                <p className="text-slate-300">
                  $100,000 medical coverage, emergency room benefits, and comprehensive accident
                  protection - essential peace of mind for international athletes.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-300 mb-6">
                  Access to National Team Development Programs, sanctioned tournaments, and
                  potential qualification for exclusive training programs in Dallas, Texas.
                </p>

                <h3 className="text-xl font-bold text-yellow-400 mb-4">6-Month Platform Access</h3>
                <p className="text-slate-300">
                  Full Go4It Sports platform including GAR analysis, StarPath progression, AI
                  coaching, and college recruitment tools - your digital advantage.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Join our Mexico tour and get official USA Football credentials plus 6 months of Go4It
            platform access. Your pathway to American football starts here.
          </p>
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <a
              href="/contact"
              className="bg-slate-600 hover:bg-slate-500 text-white px-8 py-4 rounded-lg font-bold transition-colors"
            >
