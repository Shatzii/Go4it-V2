...
export const documentLibrary: MediaAsset[] = [
  ...
  },
  {
    ...
    filename:
      'Enrollment 25 - League Marketing Kit - Athlete Membership Flyer[1509453183]_Print_1754352942228.pdf',
  ...
  },
  {
    ...
    filename:
      'Enrollment 25 - League Marketing Kit - Coach Membership Flyer[1509453183]_Print_1754352942228.pdf',
  ...
  },
  {
    ...
    filename:
      'Enrollment 25 - League Marketing Kit - CoachCertificationFlyer[1509453183]_Print_1754352942228.pdf',
...
export function searchAssets(query: string): MediaAsset[] {
  ...
  return [...mediaLibrary, ...documentLibrary].filter(
    (asset) =>
