...
export default function AITeacherChat() {
  ...
  const getWelcomeMessage = (teacher: AITeacher) => {
    const welcomes = {
      newton: "Hello! I'm Professor Newton, your mathematics tutor. I love helping students discover the beauty and logic in numbers. What mathematical concept would you like to explore today?",
      curie: "Greetings! I'm Dr. Curie, and I'm passionate about science! Let's explore the wonders of the natural world together. What scientific question has been sparking your curiosity?",
      shakespeare: "Welcome, dear student! I'm Ms. Shakespeare, and I believe every story matters. Whether it's reading, writing, or expressing yourself, I'm here to help you find your voice. What would you like to work on today?",
      timeline: "Hello there! I'm Professor Timeline, and I love bringing history and social studies to life through stories. The past has so much to teach us about the present. What historical period or topic interests you?",
      picasso: "¡Hola! I'm Maestro Picasso, and I believe art is everywhere! Whether you're drawing, painting, making music, or expressing creativity in any form, I'm here to inspire you. What artistic adventure shall we embark on?",
      inclusive: "Hello! I'm Dr. Inclusive, and I'm here to support your unique learning journey. Every student learns differently, and that's what makes education beautiful. How can I help you succeed today?"
    }
    return welcomes[teacher.id as keyof typeof welcomes] || "Hello! How can I help you learn today?"
  }
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const errorMessage: Message = {
        id: (Date.now() + 1).toString(),
        content: "I'm sorry, I'm having trouble connecting right now. Let me try to help you in a different way!",
        role: 'assistant',
        timestamp: new Date(),
        teacherId: selectedTeacher.id
      }
  ...
  const generateFallbackResponse = (teacher: AITeacher, userMessage: string) => {
    const responses = {
      newton: "That's an excellent question about mathematics! Let me break this down step by step for you...",
      curie: "What a fascinating scientific inquiry! Let's investigate this together through observation and experimentation...",
      shakespeare: "What beautiful thinking! Let's explore this topic and find the perfect words to express your ideas...",
      timeline: "That's a wonderful question about our world! Let me tell you a story that helps explain this...",
      picasso: "¡Fantástico! I love your creative thinking! Let's express this idea through art and imagination...",
      inclusive: "Thank you for sharing that with me. Everyone learns differently, and I'm here to support your unique way of understanding..."
    }
    return responses[teacher.id as keyof typeof responses] || "That's a great question! Let me help you explore this topic."
  }
