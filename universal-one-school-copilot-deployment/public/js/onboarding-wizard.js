...
class OnboardingWizard {
  constructor(options = {}) {
    ...
    this.characters = {
      stella: {
        ...
        introduction: "Hi there! I'm Stella, your personal learning assistant. I'm here to support you every step of the way with gentle guidance and encouragement. I can help you find resources, organize your learning, and celebrate your achievements!",
        welcomeMessage: "Let's get to know each other! I'm excited to help you on your learning journey. What should I call you?",
      ...
      max: {
        ...
        introduction: "Hey there, future superstar! I'm Max, your energetic learning companion! I'm all about making learning exciting and fun. I'll help you blast through challenges and celebrate your awesome victories!",
        welcomeMessage: "Ready for an amazing learning adventure? Let's go! First things first - what's your name, champion?",
      ...
      nova: {
        ...
        accentColor: '#8e44ad',
        personality: 'calm',
        introduction: "Hello there. I'm Nova, your analytical learning guide. I take a methodical approach to help you understand complex topics with clarity. I'll help you organize information and develop structured learning strategies.",
        welcomeMessage: "Welcome to your personalized learning environment. To begin our work together, please share your name.",
  ...
  showStep(stepIndex) {
    ...
    this.announceToScreenReader(`Step ${this.currentStep + 1} of ${this.steps.length}: ${step.title}`);
  }
  ...
  renderCharacterSelection() {
    ...
    description.textContent = 'Your companion will help guide you through the platform and provide assistance based on your preferences. You can change your companion later in settings.';
  ...
  renderUserProfileForm() {
    ...
    const interests = [
      ...
      'Languages', 'Social Studies', 'Astronomy', 'Animals'
    ];
  ...
  renderNeurotypeSelection() {
    ...
    // Description
    const description = document.createElement('p');
    description.innerHTML = '<em>This information is kept private and only used to adapt your learning environment.</em>';
    description.style.cssText = `
      margin: 0;
      font-size: 0.9rem;
      color: rgba(255, 255, 255, 0.7);
    ...
    const neurotypes = [
      ...
      },
      {
        id: 'adhd',
        name: 'ADHD',
        description: 'I may benefit from structured content with frequent breaks and interactive elements.'
      },
      {
        id: 'autism',
        name: 'Autism Spectrum',
        description: 'I may benefit from clear instructions, predictable patterns, and reduced sensory distractions.'
      },
      {
        id: 'dyslexia',
        name: 'Dyslexia',
        description: 'I may benefit from alternative text presentations, audio support, and multisensory approaches.'
      },
      {
        id: 'dyscalculia',
        name: 'Dyscalculia',
        description: 'I may benefit from visual aids for mathematical concepts and step-by-step instructions.'
      },
      {
        id: 'dyspraxia',
        name: 'Dyspraxia',
      ...
      },
      {
        ...
        description: 'I may benefit from customizable interface settings to reduce sensory overwhelm.'
      },
      {
        id: 'executive',
        name: 'Executive Function Challenges',
        description: 'I may benefit from task breakdowns, visual schedules, and organization support.'
      }
    ];
      ...
      neurotypeOption.addEventListener('click', () => {
        ...
        if (neurotype.id === 'neurotypical' && checkbox.checked) {
          ...
          if (neurotypicalOption && neurotypicalOption.checked) {
            ...
            neurotypicalOption.closest('.neurotype-option').style.backgroundColor = 'rgba(255, 255, 255, 0.05)';
  ...
  renderCurriculumPreview() {
    ...
    if (this.userProfile) {
      ...
      const interests = this.userProfile.interests && this.userProfile.interests.length > 0 
  ...
  loadUserPreferences() {
    ...
    if (savedProfile) {
      try {
        ...
        if (this.userProfile.preferredCharacter && this.characters[this.userProfile.preferredCharacter]) {
