...
const helpCharacters = {
  ...
  stella: {
    ...
    greeting: "Hi {name}! I'm Stella, your personal learning assistant. What can I help you with today?",
    farewell: "You're welcome, {name}! Remember, I'm here anytime you need assistance. Just click on the star icon to chat with me. Have a productive day!",
    animation: "bounce",
  ...
  max: {
    ...
    greeting: "Hey {name}! Max here, ready to blast off on your learning adventure! What awesome stuff are we working on today?",
    farewell: "Rock on, {name}! You're crushing it! Hit me up anytime you need a boost. I'm just a click away!",
    animation: "pulse",
  ...
  nova: {
    ...
    accentColor: "#8e44ad",
    personality: "calm",
    greeting: "Hello {name}, I'm Nova. I'm here to provide clarity and guidance for your learning journey. How may I assist you today?",
    farewell: "Glad I could be of assistance, {name}. Remember that learning is a process, and I'm here to support you every step of the way.",
    animation: "glow",
...
const helpResponses = {
  ...
  "curriculum": {
    stella: "The Curriculum Generator helps you create dyslexia-friendly learning materials. Just select your subject, grade level, and learning format, then let our AI generate custom materials designed specifically for your learning style. You can access it directly from your Study Tools section!",
  ...
  "medication": {
    stella: "According to your medication timeline, you should take Adderall XR 10mg at 7:30 AM with breakfast. Your next medication check-in is scheduled for April 25th at 11:00 AM. Would you like to open the Medication Tracker for more details?",
  ...
  "conversation-partner": {
    stella: "The AI Conversation Partner helps you practice speaking in your target language. Just select your language, choose a conversation topic, and start talking! The AI will respond naturally and provide feedback on your pronunciation and grammar. You can also adjust the difficulty level based on your comfort. Would you like to start with Spanish, German, or Japanese?",
  ...
  "vocabulary": {
    stella: "I understand that vocabulary can be challenging. Here are some strategies that might help: 1) Try using the Vocabulary Builder tool with spaced repetition, 2) Use the multi-modal learning approach to connect words with images and sounds, 3) Focus on thematic word groups rather than random words, and 4) Practice with the language games that emphasize vocabulary retention. Would you like me to create a personalized vocabulary plan for you?",
  ...
  "current-assignment": {
    stella: "I'd be happy to help with your current assignment. Please navigate to the specific assignment in your learning modules, and I'll provide specific guidance for that material.",
  ...
  "accessibility": {
    stella: "You can customize your learning experience by clicking on your avatar and selecting 'Accessibility Settings'. There you can adjust text size, change color contrast, enable text-to-speech, and customize your reading guides.",
  ...
  "tutor": {
    stella: "I'll connect you with a tutor who specializes in neurodivergent learning styles. Available times today are 4:00 PM or 6:30 PM. Would you like me to schedule a session?",
  ...
  "farewell": {
    stella: "You're welcome! Remember, I'm here anytime you need assistance. Just click on the star icon to chat with me. Have a productive day!",
...
function getContextualHelpTopics() {
  ...
  // Get page topics
  const pageTopics = contextualHelpTopics[currentPage] || contextualHelpTopics["superhero-school/student-dashboard"];
