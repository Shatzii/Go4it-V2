...
export class MultiAngleSynchronizer {
  ...
  private async analyzeAngle(angleId: string, frameData: ArrayBuffer): Promise<Partial<AdvancedVideoAnalysis>> {
  ...
  private async analyzeOverheadView(frameData: ArrayBuffer): Promise<Partial<AdvancedVideoAnalysis>> {
  ...
  private async performCompositeAnalysis(syncedFrame: SynchronizedFrame): Promise<AdvancedVideoAnalysis> {
  ...
  private performWeightedComposite(analyses: Partial<AdvancedVideoAnalysis>[]): AdvancedVideoAnalysis {
  ...
  private performConsensusComposite(analyses: Partial<AdvancedVideoAnalysis>[]): AdvancedVideoAnalysis {
    // Consensus-based combination
    return this.performWeightedComposite(analyses); // Simplified for now
  }
  
  private performHierarchicalComposite(analyses: Partial<AdvancedVideoAnalysis>[]): AdvancedVideoAnalysis {
    // Hierarchical combination with primary angle priority
    return this.performWeightedComposite(analyses); // Simplified for now
  }
  
  private weightedAverage(analyses: Partial<AdvancedVideoAnalysis>[], field: string, weights: any): number {
