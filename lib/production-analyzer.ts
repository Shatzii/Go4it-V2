...
export class ProductionAnalyzer {
  ...
  private async generateAnalysis(videoPath: string, sport: string) {
    ...
    const garScore = Math.round((technical + athleticism + gameAwareness + mental + biomechanics) / 5);
    ...
    return {
      ...
      strengths: this.generateStrengths(sport, { technical, athleticism, gameAwareness, mental, biomechanics }),
      improvements: this.generateImprovements(sport, { technical, athleticism, gameAwareness, mental, biomechanics }),
