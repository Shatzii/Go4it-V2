...
import { Bot, Target, Trophy, Star, Clock, CheckCircle, Play, Pause, BarChart3, TrendingUp, Award, BookOpen, Settings, Cpu } from 'lucide-react'
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Personalized training with AI-powered guidance</p>
              </div>
            </div>
            ...
            {starPathStatus && (
              <div className="flex items-center gap-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary">{starPathStatus.currentLevel}</div>
                ...
                <div className="w-32">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-sm font-medium">{Math.round(starPathStatus.progress * 100)}%</span>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select 
                  ...
                  onChange={(e) => setSessionConfig({...sessionConfig, currentLevel: e.target.value})}
                >
              ...
              <div>
                ...
                <textarea 
                  ...
                  onChange={(e) => setSessionConfig({...sessionConfig, goals: e.target.value})}
              ...
              <div>
                ...
                <textarea 
                  ...
                  onChange={(e) => setSessionConfig({...sessionConfig, weaknesses: e.target.value})}
              ...
              {activeSession.drills.map((drill) => (
                <div 
                  ...
                  className={`bg-card rounded-lg p-6 border transition-all cursor-pointer hover:shadow-lg ${
                    drill.completed ? 'border-green-500 bg-green-50' : 
                    selectedDrill?.id === drill.id ? 'border-primary' : 'border-border'
                  }`}
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <span className={`px-2 py-1 rounded text-xs font-medium ${getDifficultyColor(drill.difficulty)}`}>
                      {drill.difficulty}
                    </span>
          ...
          <div className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="text-center py-12">
              <p className="text-muted-foreground">
                Detailed progress analytics will be displayed here once you complete some training sessions.
              </p>
            </div>
          </div>
        )}
