    ...
    <div className="space-y-6">
      ...
      <Card className="bg-slate-800/50 border-slate-700">
        <CardHeader>
          ...
          <CardDescription>AI-powered biomechanical analysis for {sport}</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="relative">
            ...
            <div className="flex items-center justify-between mt-4">
              <div className="flex items-center gap-2">
                <Button variant="outline" size="sm" onClick={togglePlayback} disabled={!videoUrl}>
                  {isPlaying ? <Pause className="w-4 h-4" /> : <Play className="w-4 h-4" />}
                </Button>
                <Button variant="outline" size="sm" onClick={restartVideo} disabled={!videoUrl}>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="text-center">
                    <div
                      className={`text-4xl font-bold ${getScoreColor(analysis.technique.score)}`}
                    >
                      {analysis.technique.score.toFixed(1)}
                    </div>
                    <div className="text-slate-400 text-sm">Overall Score</div>
                    <Badge
                      variant={getScoreBadgeVariant(analysis.technique.score)}
                      className="mt-2"
                    >
                      {analysis.technique.score >= 80
                        ? 'Excellent'
                        : analysis.technique.score >= 60
                          ? 'Good'
                          : 'Needs Work'}
                    </Badge>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xs text-slate-500 mt-1">Professional level: 90+</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span
                        className={`font-medium ${getScoreColor(analysis.biomechanics.balance)}`}
                      >
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span
                        className={`font-medium ${getScoreColor(analysis.biomechanics.coordination)}`}
                      >
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span
                        className={`font-medium ${getScoreColor(analysis.biomechanics.efficiency)}`}
                      >
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      <div
                        className={`text-3xl font-bold ${getScoreColor(analysis.prediction.potentialRating)}`}
                      >
