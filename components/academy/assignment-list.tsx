...
export default function AssignmentList({
  ...
  const filteredAssignments = assignments.filter(
    (assignment) => selectedType === 'all' || assignment.type === selectedType,
  );
              ...
              <CardContent className="space-y-3">
                ...
                {grade && (
                  <div className="space-y-2">
                    ...
                    <Progress value={(grade.points / assignment.maxPoints) * 100} className="h-2" />
                    {grade.letterGrade && (
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  {status === 'graded' && grade?.feedback && (
                    <Button
                      ...
                      variant="outline"
                      onClick={() =>
                        (window.location.href = `/assignments/${assignment.id}/feedback`)
                      }
                    >
                      Feedback
                    </Button>
