...
export default function Sidebar({ isOpen, toggleSidebar }: SidebarProps) {
  ...
  const navItems = [
    ...
    { name: "Configure Server", icon: "settings", path: "/servers/configure" },
    { name: "Deploy Site", icon: "rocket_launch", path: "/deployment/deploy" },
    { name: "Deployment", icon: "cloud_upload", path: "/deployment" },
    { name: "Integrations", icon: "sync", path: "/integrations" },
  ];
